# Weekly AI-Driven Stock Picks & Learning Loop

## How to use

1. Clone this repo or otherwise copy this folder onto your computer.
2. On weekends, prompt something like "Run the weekend process" in Claude Code running against this folder.
3. After the process completes, expect a response which includes a market brief followed by a suggested allocation table.
